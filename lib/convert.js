...
exports = module.exports = function convert(input_path, quality, callback) {
  ...
  fs.exists(input_path, function (exists) {
    ...
    // Tesseract OCR preprocess references:
    // - https://mazira.com/blog/optimal-image-conversion-settings-tesseract-ocr

    var cmd = 'gs -sDEVICE=tiffgray -dNumRenderingThreads=4 -dINTERPOLATE -c 50000000 setvmthreshold -r720x720 -g6120x7920 -sCompression=lzw -o "' + output_path + '" "'+input_path+'"';
