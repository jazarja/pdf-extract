            ...
            fs.readFile(text_output_path, 'utf8', function (err, output) {
                ...
                if (parseTsv) {
                    ...
                    for(var page=1;page<=totalPage;page++) {
                        var currentPageElement = _.filter(allElements, function(item) { return item.page==page; });

                        _.each(currentPageElement, function (char) {
                        ...
                        _.each(lines, function (line) {
                            ...
                            line.list = currentPageElement = _.sortBy(line.list, ['x']);
